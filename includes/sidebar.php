  ...
  <!-- Side Widget -->
  <div class="card my-4 text-right">
      <h5 class="card-header">أخر الاخبار</h5>
      <div class="card-body">
          <ul class="mb-0">
              <?php
  ...
  <!-- Side Widget -->
  <div class="card my-4 text-right">
      <h5 class="card-header">اشهر العناوين</h5>
      <div class="card-body">
          <ul>
              <?php
        ...
        while ($result = mysqli_fetch_array($query1)) {?>
              <li>
                  <a
                      href="news-details.php?nid=<?php echo htmlentities($result['pid']) ?>"><?php echo htmlentities($result['posttitle']); ?></a>
              </li>
              <?php } ?>
          </ul>
      </div>
