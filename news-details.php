...
<head>
  ...
  <title>وزارة التعليم | الاخبار </title>
    ...
    <div class="row" style="margin-top: 4%">
      ...
      <div class="col-md-8">
        ...
        ?>
          ...
          <div class="card mb-4text-right" dir="rtl">

            <div class="card-body text-right" dir="rtl" style="
    padding-bottom: 60px;">
              ...
              <p>
                ...
                <b>تم نشره بواسطة </b> <?php echo htmlentities($row['postedBy']); ?> | بتاريخ
                </b><?php echo htmlentities($row['postingdate']); ?>
                <?php if ($row['lastUpdatedBy'] != '') : ?>
                  <b>اخر تحديث فى </b> <?php echo htmlentities($row['lastUpdatedBy']); ?>
                  </b><?php echo htmlentities($row['UpdationDate']); ?>
              </p>
            <?php endif; ?>
            <p>
              <b>مرات الزيارة:</b> <?php print $visits; ?>
            </p>
            <hr />
        ...
        <div class="card my-4 text-right">
          ...
          <div class="card-body">
            <form name="Comment" method="post" onsubmit="return validateForm()">
              ...
              <div class="form-group">
                <textarea class="form-control" name="comment" rows="3" placeholder="تعليق" required></textarea>
              </div>
          ...
          <div class="media mb-4">
            ...
            <div class="media-body">
              <h5 class="mt-0"><?php echo htmlentities($row['name']); ?> <br />
                <span style="font-size:11px;"><b>فى</b>
